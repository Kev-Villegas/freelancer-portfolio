...
const Header = () => {
  ...
  return (
    <header className="relative z-[999]">
      <motion.div
        className="fixed left-1/2 top-0 h-[4.5rem] w-full rounded-b-3xl border border-white border-opacity-40 bg-slate-900 bg-opacity-80 shadow-md shadow-white/[0.4] backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[36rem] sm:rounded-full"
